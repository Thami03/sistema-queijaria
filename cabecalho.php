                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Sobre o sistema</h6>
                                </div>
                                <div class="card-body">
                                    <p>Esse sistema foi desenvolvido 
									com o objetivo de ajudar pequenas queijarias,
									auxiliando em diversas coisas, como estoque e finanças..</p>
                                </div>
                            </div>
